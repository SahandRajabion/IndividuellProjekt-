   ...
   Laddar. Vänligen vänta.<br />
    ...
    <div id="positions"></div>
     ...
     <asp:ListView ID="VideoListView" runat="server"
        ...
        <asp:HyperLink ID="LinkButton" runat="server"  CssClass="buttonClassredigera" NavigateUrl='<%# GetRouteUrl("edit", new { id = Item.VideoID }) %>' CausesValidation="false">Redigera</asp:HyperLink>
